...
public class DBConstants {
    ...
    //L'utilisation du mot clé DESC permet, associé au limit 1, de renvoyer le OutTime dans la bonne cellule de la base
    // de donnée
    ...
    public static final String IS_RECURRING = "SELECT COUNT(*) FROM ticket WHERE VEHICLE_REG_NUMBER LIKE ?";
}
